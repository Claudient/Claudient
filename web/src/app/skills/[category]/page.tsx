...
import { getSkillsByCategory, CATEGORY_LABELS, SKILL_CATEGORIES_LIST } from '@/lib/content'
...
export default async function CategoryPage({ params }: Props) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <h1 className="text-4xl font-black mb-1">{label}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {skills.map(skill => (
          ...
          >
            <h2 className="font-black text-xl mb-1 group-hover:underline">{skill.title}</h2>
