...
> Voor een durfkapitaal of angel investor die dealflow, due diligence, portfoliobewaking en LP-relaties beheert via een gestructureerde pipeline van sourcing, IC memos en kwartaalrapportage.

## Stack

- **Notion** of **Airtable** — Deal CRM, pipeline kanban, portfolio tracker, bedrijfsdatabase
- **Carta** — Cap table beheer, equity tracking, pro-rata rights, option pool modellering
- **AngelList** of **Visible** — LP rapportage, fund performance dashboards, investor updates
- **QuickBooks** — Fund accounting, management fee tracking, carried interest berekeningen
- **Pitchbook** of **Crunchbase** — Marktgegevens, comp sets, valuatiebenchmarks, sector mapping
- **Slack** — Founder channels, co-investor threads, IC async discussie, deal room channels
- **Google Workspace** — Drive voor diligence docs, Sheets voor KPI tracking, Docs voor memos
