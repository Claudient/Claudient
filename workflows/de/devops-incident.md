...
Ein strukturierter Workflow für DevOps- und SRE-Ingenieure mit Claude Code — vom ersten Alert über Triage und War-Room-Koordination bis zu Behebung und Postmortem.

---

## Überblick

**Zeitersparnis:** Strukturierte Incident-Response mit Claude reduziert die kognitive Belastung bei stressigen Ereignissen, verkürzt die Postmortem-Schreibzeit um 60 % und stellt sicher, dass Runbook-Lücken vor dem nächsten Incident erfasst werden.

**Was dieser Workflow abdeckt:**
- Alert auslöst → Triage → Schweregradbewertung
- P1-War-Room-Koordination
- Parallele Untersuchungsstränge
- Stakeholder-Kommunikation während des Incidents
- Behebung und Verifikation
- Postmortem-Prozess

**Voraussetzung:** `/incident-response` und `/oncall-runbook` installiert. Empfohlen: PagerDuty oder OpsGenie MCP verbunden, Runbooks über Claude zugänglich.

---

## Phase 1: Alert löst aus (0–5 Minuten)

### Erste 60 Sekunden — Schweregrad-Triage

Rufe niemanden an und starte keinen War Room, bevor du 60 Sekunden zur Bewertung aufgewendet hast.
...
**Entscheidungsregel:**
- P1 → sofort zu Phase 2 (War Room)
- P2 → 10 Minuten selbst untersuchen, bevor andere gerufen werden; falls keine Lösung in Sicht, eskalieren
- P3 → untersuchen und während der normalen Arbeitszeit beheben; sich selbst erinnern, nicht andere rufen

---

## Phase 2: War-Room-Einrichtung (nur P1 — 5–10 Minuten)

### Alarmieren und Versammeln
...
### Rolle des Incident Commanders

Bei einem P1 ist eine Person der Incident Commander. Er untersucht nicht — er koordiniert.
...
## Phase 3: Untersuchung (parallele Stränge)
...
### Entscheidung zur Schadensbegrenzung
...
## Phase 4: Kommunikation während des Incidents

### Kundenseitige Statusseiten-Aktualisierung
...
### Internes Stakeholder-Update (alle 15–30 Minuten bei P1)
...
## Phase 5: Behebung und Verifikation

### Verifikations-Checkliste zur Behebung
...
### Postmortem innerhalb von 48 Stunden nach dem Incident
...
## On-Call-Vorbereitung (vor deiner Rotation)

### Checkliste vor der Rotation

Führe dies 2 Tage vor Beginn deiner On-Call-Schicht durch:
...
|---|---|---|
| Alert bis Triage-Entscheidung | < 5 Minuten | > 10 min: Alert-Qualität oder Runbook-Lücke |
| P1-War-Room versammelt | < 10 Minuten | > 20 min: Kommunikations- oder Paging-Problem |
| Zeit bis zum ersten Behebungsversuch | < 20 Minuten | > 30 min: Untersuchungspfad unklar |
| MTTR (P1) | < 45 Minuten | > 60 min: Runbook- oder Kompetenzlücke |
| MTTR (P2) | < 2 Stunden | > 4 Stunden: Triage ungenau oder Untersuchung ineffektiv |
| Postmortem veröffentlicht | Innerhalb von 48 Stunden | > 72 Stunden: Lerneffekte gehen verloren |
| Abgeschlossene Maßnahmen | 100 % innerhalb von 30 Tagen | < 70 %: Maßnahmen sind keine echten Verpflichtungen |
| Incidents pro Monat (Trend) | Abnehmend | Stagnierend oder steigend: systemische Probleme werden nicht behoben |
