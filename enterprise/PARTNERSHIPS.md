...
We partner with three types of organizations:

### 1. Technology Partners
**AI-dev tools, platforms, and infrastructure companies**
...
**Example earnings:**
- Refer a 10-seat Business customer @ $20/seat/month = $2,400/month MRR
- Your commission: 20% = $480/month recurring (ongoing)

---

### 3. Certified Stack Publishers
**Community builders and domain experts publishing stacks in the marketplace**
...
- Co-marketing (featured in newsletters, social media)
- Higher split (80/20) for certified stacks after 6 months

**Time commitment:** One-time (build the stack), then support.

**How it works:**
1. Build a stack (10–20 skills in a cohesive domain)
2. Submit for certification review
3. Get approved → published in marketplace
4. Earn 70% of revenue from each subscription to your stack
5. Build reputation → unlock 80/20 split (Tier 2)

**Example earnings:**
- Build a "Healthcare Compliance Stack" 
- 50 customers @ $10/month = $500/month
- Your share: 70% = $350/month (or 80% = $400/month if Tier 2)
...
Approval is automatic. You get your unique referral link and partner dashboard within 24 hours.

### Certified Stack Publishers
1. Build the stack locally (10+ skills + 2+ commands + 1+ hook)
2. Submit to `marketplace/submissions/` with a README explaining the stack
3. We review (1–2 weeks) for quality, completeness, and brand fit
4. If approved: publish + earn revenue share
5. First stack: 70/30 split. After 6 months: apply for 80/20 Tier 2

---

## Partner Benefits (All Tiers)

| Benefit | Tech Partner | Consulting | Stack Publisher |
|---------|--------------|-----------|-----------------|
| Logo on README | ✅ | – | – |
| Co-marketing | ✅ | – | ✅ |
| Revenue share | Optional | ✅ 20% | ✅ 70–80% |
| Free licenses | ✅ 10 seats | ✅ 5 seats | ✅ 5 seats |
| Partner Slack | ✅ | ✅ | ✅ |
| Sales support | – | ✅ | Optional |
| Featured placement | – | – | ✅ (if certified) |
| Uptime SLA | – | – | N/A |
