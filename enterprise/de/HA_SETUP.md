...
- Konsistenzprüfungen ausführen: `uitkit-cli db verify-consistency`
  ...
  - name: uitkit_ha
    rules:
      ...
      - alert: ReadOnlyModeActive
        ...
        for: 0s
        annotations:
          summary: "UitKit im NUR-LESEN-Modus (Schreibvorgänge deaktiviert)"
