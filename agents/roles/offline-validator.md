...
Stack path: /opt/uitkit/backend_stack
...
1. **Stack path** — e.g., `/opt/uitkit/backend_stack`
...
```json
{
  ...
  "security_requirements": {
    ...
    "audit_logging": "enable JSON audit trail to /var/log/uitkit-audit.jsonl",
