...
**Verwachte uitvoer:** Volledige README met hero-beschrijving, npm/licentie/taal-badges, installatiesectie (`npx uitkit add all`), CLI-referentietabel voor alle subcommando's, categorielijst, bijdragende sectie, MIT-licentievoettekst.
