...
**Red flags present:**
1. **Protected activity (recent complaint):** Employee filed a complaint 3 months ago. Terminating within 6 months of protected activity creates a strong retaliation claim, even if performance issues are real.

2. **Age (40+ employee):** ADEA applies. Documentation must show the same standard applied equally to younger employees. One email does not meet this standard.

3. **Documentation gap — critical:** No PIP, no written warnings, no documented performance conversations. "One email 6 months ago" will not withstand scrutiny. A court or regulator will ask why you didn't give them a fair chance to improve.
...
1. Consult employment lawyer now — before any communication to the employee
2. Consider whether a structured PIP is appropriate (and legally required under company policy)
3. Document all future performance conversations
