...
**Structure**:
1. Micro-personalization (1 line): reference something they said, did, or built.
2. One relevant question (1-2 lines): about their work, challenge, or perspective. Not "How are you?"
3. No links, no PDFs, no attachments in the first message.
4. No CTA. No "let's hop on a call." No "I'd love to chat." Let them respond naturally.
...
1. First 5 seconds: Warm greeting, reference specific insight (post, role, company).
2. Next 15 seconds: One focused problem or observation tied to their world.
3. Last 10 seconds: One question. Keep it open-ended, not leading.
