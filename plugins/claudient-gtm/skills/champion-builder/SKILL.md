...
- Your primary contact is engaged but hasn't taken any internal actions on your behalf
- You need to get to the economic buyer but don't have a path
- The deal is stuck and you suspect it's because there's no internal advocate creating urgency
- You want to coach your champion on how to sell internally — what to say, what to show, to whom

## When NOT to use
- You haven't had any meetings with the buyer yet — run discovery first to identify who might be a champion
- You already have a confirmed, active champion who is moving the deal — `/deal-review` to maintain deal health
- You need to create a formal joint plan document — use `/mutual-success-plan`
- You're handling a multi-stakeholder negotiation — that's a different skill set from champion building

## Instructions

### Champion identification and assessment

```
Assess whether [Name / Title] is a strong champion for this deal.
...
### Champion enablement — arm them to sell internally
...
### Champion re-engagement (gone quiet)
