...
## When to activate
- Writing or updating your returns and refunds policy
- Responding to a customer return request, refund demand, or complaint
- Handling a chargeback or payment dispute
- A customer is escalating aggressively and you need a measured response
- Analysing return data to find product or process issues driving the rate up
- Training customer service staff on returns handling standards

## When NOT to use
- Complex legal disputes — get a lawyer, not Claude
- Volume processing of returns in your Shopify/WooCommerce admin — use your platform's native tools
- Fraud investigation requiring order-level data analysis — use your platform's fraud tools
- Cases where you've already made a final business decision — don't use AI to rubber-stamp it
...
### Customer return response templates
...
**User:** A customer is demanding a full refund on a $180 pair of boots. They say "the sole is already peeling after 3 weeks." This is within my 30-day window. They've sent one photo that's blurry and doesn't clearly show the defect.
