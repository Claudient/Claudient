...
## When to activate
- Launching a new product on Amazon, Shopify, Etsy, eBay, or other marketplaces
- An existing listing has low conversion rate, high bounce rate, or poor search rank
- Preparing seasonal listings (Q4, Prime Day, Black Friday) for maximum performance
- Rewriting inherited listings that were written without SEO or CRO intent
- Building A+ Content / Enhanced Brand Content for an Amazon brand
- Creating a brief for a product photographer so images support the copy

## When NOT to use
- Bulk optimisation of 500+ SKUs at once — break into batches of 20-30, prioritise by revenue
- Digital/service products — listing structure differs significantly
- B2B catalogue products where your buyer is procurement not a consumer
- When you don't have the product in hand yet — copy without product knowledge produces generic filler

## Instructions

### Full listing optimisation prompt
...
**User:** Optimise my Amazon listing for a stainless steel insulated water bottle. It's 32oz, keeps drinks cold 24h, has a leak-proof lid. Main competitor is Hydro Flask. $28 price point. Target customer: outdoor enthusiasts and gym-goers.
