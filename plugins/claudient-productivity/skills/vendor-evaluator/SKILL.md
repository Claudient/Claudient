...
## When to activate
- Evaluating 2+ vendors for any significant software, service, or supplier decision
- Building a scoring rubric before demos or reference calls so evaluation is consistent
- Writing an RFI or RFP to send to prospective vendors
- Summarising vendor proposals into a comparison matrix for a decision
- Drafting a vendor recommendation memo for leadership or a board
- Running a renewal review on an existing vendor relationship

## When NOT to use
- Buying something cheap with no real alternative (e.g., a single $50/month SaaS tool) — just buy it
- When the decision is already made and you're rationalising it — be honest
- Legal contract negotiation — that's for Legal with vendor context; this skill helps scope and compare, not negotiate
- Evaluating job candidates — use a hiring rubric instead

## Instructions

### Full RFP template generator
...
**User:** We're choosing between three HRIS systems — BambooHR, Rippling, and Workday. We're a 200-person B2B SaaS company. Help me evaluate them.
