---
name: "/autofix-pr — Automatic PR Fix Application"
description: "User wants Claude to automatically apply code review suggestions without manual intervention; user mentions `/autofix-pr`; user wants hands-off PR refinement after pushing code and receiving reviewer "
---
