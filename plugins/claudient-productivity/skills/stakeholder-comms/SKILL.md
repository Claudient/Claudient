...
## When to activate
- Drafting a company-wide announcement (reorg, leadership change, product pivot, policy update)
- Writing sensitive communications that could be misread — layoffs, bad news, difficult changes
- Preparing the executive for an all-hands meeting — script, Q&A prep, key messages
- Drafting board communications — meeting summaries, off-cycle updates, sensitive requests
- Writing to investors, partners, or media with precision and care
- Any communication where the wrong word in the wrong place causes a real problem

## When NOT to use
- Routine internal communications that carry no risk — use standard email
- Legal filings or regulatory submissions — work with legal counsel
- Public press releases requiring media relations expertise — coordinate with your PR team
- Real-time crisis communications — this skill helps draft, not manage real-time response

## Important

Sensitive communications — especially around layoffs, leadership transitions, and financial performance — must be reviewed by legal and HR before distribution. Claude helps draft efficiently and catch tone issues, but does not replace legal review.

## Instructions

### Company announcement prompt
...
### Layoff / reduction in force communication
...
### Board communication — off-cycle update
...
### Sensitive 1:1 communication — executive to report
...
**User:** Our CEO needs to announce that we're closing our London office and moving those 12 employees to remote-first or offering voluntary redundancy. The company is profitable but the office costs £40K/month and the team has been largely remote since COVID anyway. We need an all-employee email, talking points for the London manager, and a note to the 12 affected employees specifically.
