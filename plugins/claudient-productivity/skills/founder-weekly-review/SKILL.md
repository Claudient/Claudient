...
## When to activate
- Running your end-of-week or start-of-week company review
- Checking OKR progress against quarterly targets
- Preparing your weekly all-hands or leadership sync agenda
- Deciding where to personally focus next week
- Sensing whether the team is stretched, blocked, or misaligned
- Writing a weekly internal update memo to the team

## When NOT to use
- Board prep — use the `/board-deck-builder` skill
- Investor update — use the `/investor-update` skill
- One-off strategic decisions — this is a rhythm tool, not a decision framework
- Deep financial analysis — use `/financial-plan` or `/dcf-model`

## Instructions

### Core weekly review prompt
...
**User:** Week ending June 1. ARR $890K (up $22K). Closed one $12K ACV deal, lost one $8K deal to competitor. Shipped API rate limiting feature. One engineer was quiet in 1:1 and said they feel "stretched." Q2 OKR for $1.1M ARR by June 30 — now at risk. Cash: $1.1M left, burn $95K/month.
